# SPDX-PackageName: Sprinkles
# SPDX-PackageHomePage: https://git.afnix.fr/sprinkles/sprinkles
...
fix (self: {
  ...
  toOverride =
    ...
    if builtins.isFunction x then
      ...
      let
        xWithPrev = x prev;
      in
      if builtins.isFunction xWithPrev then x final prev else xWithPrev
    else
      final: prev: x;
  ...
  */
  fixOverridableWith =
    ...
    // e
    // {
      override = o: self.fixOverridableWith e (self.fixWithOverride (self.toOverride o) f);
    };
